...
**错误信息**: `✗ 订阅错误: alert rate limit exceeded`

**原因：** 订阅的币种和区块链组合产生的警报超过每小时 100 条限制

**解决方案：**
1. 减少订阅的币种数量（建议 3-5 个）
2. 增加最小转账金额
3. 减少区块链数量或留空

**详细解决方案请参考**: [RATE_LIMIT_FIX.md](./RATE_LIMIT_FIX.md)

### 问题 5: 价格获取失败（USDTUSDT 等）

**错误信息**: `获取价格失败 USDTUSDT: 400 Client Error`

**原因：** 稳定币（USDT、USDC 等）没有对应的 USDT 交易对

**解决方案：**
- ✅ 代码已自动修复：稳定币会自动使用 1.00 作为价格
- 无需手动配置
